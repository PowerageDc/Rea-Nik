...
// Función, no variable: NIK_LUA_COMMANDS.statePoll.commandId recién queda
// resuelto al valor real de esta PC después de que config.local.js pise el
// default de acá — si esto fuera una variable simple, quedaría congelada
// con el valor viejo de config.js para siempre (bug real, dev 2026-09-06:
// ReaPitch/Playrate sin datos porque el poll llamaba a un Command ID de
// una versión vieja de Nik_RemoteState_Poll.lua, sin error visible).
function nikBuildSlowPoll() {
...
var NIK_ONDEMAND_READS = nikBuildSlowPoll;
